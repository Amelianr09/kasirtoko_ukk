<nav class="sb-topnav navbar navbar-expand navbar-light bg-blue shadow-sm">
    <button class="btn btn-link btn-sm" id="sidebarToggle" href="#">
        <i class="fas fa-bars fa-fw font-weight-bold text-white"></i>
    </button>
    <a img src="path-to-your-logo-image.png" alt="Logo Website" class="navbar-brand order-lg-first text-sm-center font-weight-bold" href="<?= base_url(); ?>"><i class="fas fa-magic"></i> BeautyZone</a>
    <!-- Navbar-->
